    ...
    */
    ...
    public:
        ...
        */
        ...
        void partial_decrypt(const Ciphertext &encrypted, Plaintext &noise, Plaintext &destination);

        void final_decrypt(const Ciphertext &encrypted, Plaintext *c1s, size_t partyNum, Plaintext &destination);
